...
public class PKIXPolicyNode implements PolicyNode {
   ...
   public PKIXPolicyNode copy() {
      ...
      PKIXPolicyNode var4 = new PKIXPolicyNode(new ArrayList(), this.depth, var1, null, var3, this.validPolicy, this.critical);

      for (PKIXPolicyNode var5 : this.children) {
         var4.addChild(var5.copy());
      }
