...
public final class DigestFactory {
   ...
   public static Digest cloneDigest(Digest var0) {
      return ((DigestFactory.Cloner)cloneMap.get(var0.getAlgorithmName())).createClone(var0);
   }

   static {
      cloneMap.put(createMD5().getAlgorithmName(), new DigestFactory.Cloner() {
         @Override
         public Digest createClone(Digest var1) {
            return new MD5Digest((MD5Digest)var1);
         }
      });
      cloneMap.put(createSHA1().getAlgorithmName(), new DigestFactory.Cloner() {
         @Override
         public Digest createClone(Digest var1) {
            return new SHA1Digest((SHA1Digest)var1);
         }
      });
      cloneMap.put(createSHA224().getAlgorithmName(), new DigestFactory.Cloner() {
         @Override
         public Digest createClone(Digest var1) {
            return new SHA224Digest((SHA224Digest)var1);
         }
      });
      cloneMap.put(createSHA256().getAlgorithmName(), new DigestFactory.Cloner() {
         @Override
         public Digest createClone(Digest var1) {
            return SHA256Digest.newInstance(var1);
         }
      });
      cloneMap.put(createSHA384().getAlgorithmName(), new DigestFactory.Cloner() {
         @Override
         public Digest createClone(Digest var1) {
            return new SHA384Digest((SHA384Digest)var1);
         }
      });
      cloneMap.put(createSHA512().getAlgorithmName(), new DigestFactory.Cloner() {
         @Override
         public Digest createClone(Digest var1) {
            return new SHA512Digest((SHA512Digest)var1);
         }
      });
      cloneMap.put(createSHA3_224().getAlgorithmName(), new DigestFactory.Cloner() {
         @Override
         public Digest createClone(Digest var1) {
            return new SHA3Digest((SHA3Digest)var1);
         }
      });
      cloneMap.put(createSHA3_256().getAlgorithmName(), new DigestFactory.Cloner() {
         @Override
         public Digest createClone(Digest var1) {
            return new SHA3Digest((SHA3Digest)var1);
         }
      });
      cloneMap.put(createSHA3_384().getAlgorithmName(), new DigestFactory.Cloner() {
         @Override
         public Digest createClone(Digest var1) {
            return new SHA3Digest((SHA3Digest)var1);
         }
      });
      cloneMap.put(createSHA3_512().getAlgorithmName(), new DigestFactory.Cloner() {
         @Override
         public Digest createClone(Digest var1) {
            return new SHA3Digest((SHA3Digest)var1);
         }
      });
      cloneMap.put(createSHAKE128().getAlgorithmName(), new DigestFactory.Cloner() {
         @Override
         public Digest createClone(Digest var1) {
            return new SHAKEDigest((SHAKEDigest)var1);
         }
      });
      cloneMap.put(createSHAKE256().getAlgorithmName(), new DigestFactory.Cloner() {
         @Override
         public Digest createClone(Digest var1) {
            return new SHAKEDigest((SHAKEDigest)var1);
         }
