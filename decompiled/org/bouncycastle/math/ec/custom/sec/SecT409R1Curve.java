...
public class SecT409R1Curve extends ECCurve.AbstractF2m {
   ...
   public SecT409R1Curve() {
      ...
      this.order = new BigInteger(
         1, Hex.decodeStrict("010000000000000000000000000000000000000000000000000001E2AAD6A612F33307BE5FA47C3C9E052F838164CD37D9A21173")
      );
      ...
      return new AbstractECLookupTable() {
         ...
         public ECPoint lookupVar(int var1) {
            ...
            for (int var5x = 0; var5x < 7; var5x++) {
               ...
               var3x[var5x] = var4[var4x + 7 + var5x];
            }
         ...
         private ECPoint createPoint(long[] var1, long[] var2x) {
            return SecT409R1Curve.this.createRawPoint(new SecT409FieldElement(var1), new SecT409FieldElement(var2x), SecT409R1Curve.SECT409R1_AFFINE_ZS);
         }
      };
   }
}
