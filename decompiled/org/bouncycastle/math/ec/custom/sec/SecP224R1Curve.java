   ...
   public ECLookupTable createCacheSafeLookupTable(ECPoint[] var1, int var2, final int var3) {
      ...
      return new AbstractECLookupTable() {
         ...
         private ECPoint createPoint(int[] var1, int[] var2x) {
            return SecP224R1Curve.this.createRawPoint(new SecP224R1FieldElement(var1), new SecP224R1FieldElement(var2x), SecP224R1Curve.SECP224R1_AFFINE_ZS);
         }
      };
   }
