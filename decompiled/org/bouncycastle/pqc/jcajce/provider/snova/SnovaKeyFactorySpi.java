...
public class SnovaKeyFactorySpi extends BaseKeyFactorySpi {
   ...
   public SnovaKeyFactorySpi(ASN1ObjectIdentifier var1) {
      super(var1);
   }
   ...
   public final Key engineTranslateKey(Key var1) throws InvalidKeyException {
      if (!(var1 instanceof BCSnovaPrivateKey) && !(var1 instanceof BCSnovaPublicKey)) {
