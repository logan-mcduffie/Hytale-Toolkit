...
public class BCSnovaPrivateKey implements PrivateKey, SnovaKey {
   ...
   public BCSnovaPrivateKey(SnovaPrivateKeyParameters var1) {
      this.params = var1;
   }

   public BCSnovaPrivateKey(PrivateKeyInfo var1) throws IOException {
      this.init(var1);
   }

   private void init(PrivateKeyInfo var1) throws IOException {
      this.attributes = var1.getAttributes();
      this.params = (SnovaPrivateKeyParameters)PrivateKeyFactory.createKey(var1);
   }
   ...
   public boolean equals(Object var1) {
      if (var1 == this) {
         return true;
      } else if (var1 instanceof BCSnovaPrivateKey) {
