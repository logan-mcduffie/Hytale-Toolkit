...
public class SnovaParameterSpec implements AlgorithmParameterSpec {
   ...
   private SnovaParameterSpec(SnovaParameters var1) {
   ...
   public static SnovaParameterSpec fromName(String var0) {
      return (SnovaParameterSpec)parameters.get(Strings.toLowerCase(var0));
   }
