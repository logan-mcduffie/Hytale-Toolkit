...
class JceUtils {
   ...
   static String getAlgorithm(ASN1ObjectIdentifier var0) {
      if (!PRFS.containsKey(var0)) {
         throw new IllegalStateException("no prf for algorithm: " + var0);
      } else {
         return (String)PRFS.get(var0);
      }
   }
