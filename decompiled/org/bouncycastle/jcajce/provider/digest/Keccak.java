...
public class Keccak {
   ...
   public static class Digest224 extends Keccak.DigestKeccak {
      public Digest224() {
         super(224);
      }
   }

   public static class Digest256 extends Keccak.DigestKeccak {
      public Digest256() {
         super(256);
      }
   }

   public static class Digest288 extends Keccak.DigestKeccak {
      public Digest288() {
         super(288);
      }
   }

   public static class Digest384 extends Keccak.DigestKeccak {
      public Digest384() {
         super(384);
      }
   }

   public static class Digest512 extends Keccak.DigestKeccak {
      public Digest512() {
         super(512);
      }
   }
