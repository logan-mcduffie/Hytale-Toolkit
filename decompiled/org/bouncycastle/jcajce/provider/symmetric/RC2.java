   ...
   public static class AlgParams extends BaseAlgorithmParameters {
      ...
      protected byte[] engineGetEncoded(String var1) throws IOException {
         if (this.isASN1FormatString(var1)) {
            return this.parameterVersion == -1
               ? new RC2CBCParameter(this.engineGetEncoded()).getEncoded()
               : new RC2CBCParameter(this.parameterVersion, this.engineGetEncoded()).getEncoded();
         } else {
      ...
      protected AlgorithmParameterSpec localEngineGetParameterSpec(Class var1) throws InvalidParameterSpecException {
         if ((var1 == RC2ParameterSpec.class || var1 == AlgorithmParameterSpec.class) && this.parameterVersion != -1) {
            return this.parameterVersion < 256
               ? new RC2ParameterSpec(ekb[this.parameterVersion], this.iv)
               : new RC2ParameterSpec(this.parameterVersion, this.iv);
