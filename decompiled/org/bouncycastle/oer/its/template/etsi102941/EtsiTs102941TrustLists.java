...
public class EtsiTs102941TrustLists {
   ...
   public static final OERDefinition.Builder DcEntry = OERDefinition.seq(Url.label("url"), Ieee1609Dot2BaseTypes.SequenceOfHashedId8.label("cert"))
      .typeName("DcEntry");
   public static final OERDefinition.Builder AaEntry = OERDefinition.seq(
         EtsiTs103097Module.EtsiTs103097Certificate.label("aaCertificate"), Url.label("accessPoint")
      )
      .typeName("AaEntry");
   public static final OERDefinition.Builder EaEntry = OERDefinition.seq(
         EtsiTs103097Module.EtsiTs103097Certificate.label("eaCertificate"), Url.label("aaAccessPoint"), OERDefinition.optional(Url.label("itsAccessPoint"))
      )
      .typeName("EaEntry");
   ...
   public static final OERDefinition.Builder CtlDelete = OERDefinition.choice(
         Ieee1609Dot2BaseTypes.HashedId8.label("cert"), DcDelete.label("dc"), OERDefinition.extension()
      )
      .typeName("CtlDelete");
   public static final OERDefinition.Builder CtlEntry = OERDefinition.choice(
         RootCaEntry.label("rca"), EaEntry.label("ea"), AaEntry.label("aa"), DcEntry.label("dc"), TlmEntry.label("tlm"), OERDefinition.extension()
      )
      .typeName("CtlEntry");
   public static final OERDefinition.Builder CtlCommand = OERDefinition.choice(CtlEntry.label("add"), CtlDelete.label("delete"), OERDefinition.extension())
      .typeName("CtlCommand");
   ...
   public static final OERDefinition.Builder CtlFormat = OERDefinition.seq(
         ...
         OERDefinition.integer(0L, 255L).label("ctlSequence"),
