...
public class EnrolmentResponseCode extends ASN1Enumerated {
   ...
   public EnrolmentResponseCode(int var1) {
      super(var1);
      this.assertValues();
   }

   public EnrolmentResponseCode(BigInteger var1) {
      super(var1);
      this.assertValues();
   }

   public EnrolmentResponseCode(byte[] var1) {
      super(var1);
      this.assertValues();
   }

   private EnrolmentResponseCode(ASN1Enumerated var1) {
      this(var1.getValue());
   }

   public static EnrolmentResponseCode getInstance(Object var0) {
      if (var0 instanceof EnrolmentResponseCode) {
         return (EnrolmentResponseCode)var0;
      } else {
         return var0 != null ? new EnrolmentResponseCode(ASN1Enumerated.getInstance(var0)) : null;
      }
   }
