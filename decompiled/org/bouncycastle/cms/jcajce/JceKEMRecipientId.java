...
public class JceKEMRecipientId extends KEMRecipientId {
   public JceKEMRecipientId(X509Certificate var1) {
      super(convertPrincipal(var1.getIssuerX500Principal()), var1.getSerialNumber(), CMSUtils.getSubjectKeyId(var1));
   }

   public JceKEMRecipientId(X500Principal var1, BigInteger var2) {
      super(convertPrincipal(var1), var2);
   }

   public JceKEMRecipientId(X500Principal var1, BigInteger var2, byte[] var3) {
