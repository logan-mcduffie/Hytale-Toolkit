...
public class TeleTrusTNamedCurves {
   static X9ECParametersHolder brainpoolP160r1 = new X9ECParametersHolder() {
      ...
      protected ECCurve createCurve() {
         ...
         return TeleTrusTNamedCurves.configureCurve(
            new ECCurve.Fp(
               TeleTrusTNamedCurves.fromHex("E95E4A5F737059DC60DFC7AD95B3D8139515620F"),
               TeleTrusTNamedCurves.fromHex("340E7BE2A280EB74E2BE61BADA745D97E8F7C300"),
               TeleTrusTNamedCurves.fromHex("1E589A8595423412134FAA2DBDEC95C8D8675E58"),
               var1,
               var2,
               true
            )
   ...
   static X9ECParametersHolder brainpoolP160t1 = new X9ECParametersHolder() {
      ...
      protected ECCurve createCurve() {
         ...
         return TeleTrusTNamedCurves.configureCurve(
            new ECCurve.Fp(
               TeleTrusTNamedCurves.fromHex("E95E4A5F737059DC60DFC7AD95B3D8139515620F"),
               TeleTrusTNamedCurves.fromHex("E95E4A5F737059DC60DFC7AD95B3D8139515620C"),
               TeleTrusTNamedCurves.fromHex("7A556B6DAE535B7B51ED2C4D7DAA7A0B5C55F380"),
               var1,
               var2,
               true
            )
   ...
   static X9ECParametersHolder brainpoolP192r1 = new X9ECParametersHolder() {
      ...
      protected ECCurve createCurve() {
         ...
         return TeleTrusTNamedCurves.configureCurve(
            new ECCurve.Fp(
               TeleTrusTNamedCurves.fromHex("C302F41D932A36CDA7A3463093D18DB78FCE476DE1A86297"),
               TeleTrusTNamedCurves.fromHex("6A91174076B1E0E19C39C031FE8685C1CAE040E5C69A28EF"),
               TeleTrusTNamedCurves.fromHex("469A28EF7C28CCA3DC721D044F4496BCCA7EF4146FBF25C9"),
               var1,
               var2,
               true
            )
      ...
      protected X9ECParameters createParameters() {
         Object var1 = null;
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = TeleTrusTNamedCurves.configureBasepoint(
            var2, "04C0A0647EAAB6A48753B033C56CB0F0900A2F5C4853375FD614B690866ABD5BB88B5F4828C1490002E6773FA2FA299B8F"
         );
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), (byte[])var1);
      }
   };
   static X9ECParametersHolder brainpoolP192t1 = new X9ECParametersHolder() {
      ...
      protected ECCurve createCurve() {
         ...
         return TeleTrusTNamedCurves.configureCurve(
            new ECCurve.Fp(
               TeleTrusTNamedCurves.fromHex("C302F41D932A36CDA7A3463093D18DB78FCE476DE1A86297"),
               TeleTrusTNamedCurves.fromHex("C302F41D932A36CDA7A3463093D18DB78FCE476DE1A86294"),
               TeleTrusTNamedCurves.fromHex("13D56FFAEC78681E68F9DEB43B35BEC2FB68542E27897B79"),
               var1,
               var2,
               true
            )
      ...
      protected X9ECParameters createParameters() {
         ...
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = TeleTrusTNamedCurves.configureBasepoint(
            var2, "043AE9E58C82F63C30282E1FE7BBF43FA72C446AF6F4618129097E2C5667C2223A902AB5CA449D0084B7E5B3DE7CCC01C9"
         );
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), (byte[])var1);
      }
   };
   static X9ECParametersHolder brainpoolP224r1 = new X9ECParametersHolder() {
      ...
      protected ECCurve createCurve() {
         ...
         return TeleTrusTNamedCurves.configureCurve(
            new ECCurve.Fp(
               TeleTrusTNamedCurves.fromHex("D7C134AA264366862A18302575D1D787B09F075797DA89F57EC8C0FF"),
               TeleTrusTNamedCurves.fromHex("68A5E62CA9CE6C1C299803A6C1530B514E182AD8B0042A59CAD29F43"),
               TeleTrusTNamedCurves.fromHex("2580F63CCFE44138870713B1A92369E33E2135D266DBB372386C400B"),
               var1,
               var2,
               true
            )
      ...
      protected X9ECParameters createParameters() {
         ...
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = TeleTrusTNamedCurves.configureBasepoint(
            var2, "040D9029AD2C7E5CF4340823B2A87DC68C9E4CE3174C1E6EFDEE12C07D58AA56F772C0726F24C6B89E4ECDAC24354B9E99CAA3F6D3761402CD"
         );
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), (byte[])var1);
      }
   };
   static X9ECParametersHolder brainpoolP224t1 = new X9ECParametersHolder() {
      ...
      protected ECCurve createCurve() {
         ...
         return TeleTrusTNamedCurves.configureCurve(
            new ECCurve.Fp(
               TeleTrusTNamedCurves.fromHex("D7C134AA264366862A18302575D1D787B09F075797DA89F57EC8C0FF"),
               TeleTrusTNamedCurves.fromHex("D7C134AA264366862A18302575D1D787B09F075797DA89F57EC8C0FC"),
               TeleTrusTNamedCurves.fromHex("4B337D934104CD7BEF271BF60CED1ED20DA14C08B3BB64F18A60888D"),
               var1,
               var2,
               true
            )
      ...
      protected X9ECParameters createParameters() {
         ...
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = TeleTrusTNamedCurves.configureBasepoint(
            var2, "046AB1E344CE25FF3896424E7FFE14762ECB49F8928AC0C76029B4D5800374E9F5143E568CD23F3F4D7C0D4B1E41C8CC0D1C6ABD5F1A46DB4C"
         );
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), (byte[])var1);
      }
   };
   static X9ECParametersHolder brainpoolP256r1 = new X9ECParametersHolder() {
      ...
      protected ECCurve createCurve() {
         ...
         return TeleTrusTNamedCurves.configureCurve(
            new ECCurve.Fp(
               TeleTrusTNamedCurves.fromHex("A9FB57DBA1EEA9BC3E660A909D838D726E3BF623D52620282013481D1F6E5377"),
               TeleTrusTNamedCurves.fromHex("7D5A0975FC2C3057EEF67530417AFFE7FB8055C126DC5C6CE94A4B44F330B5D9"),
               TeleTrusTNamedCurves.fromHex("26DC5C6CE94A4B44F330B5D9BBD77CBF958416295CF7E1CE6BCCDC18FF8C07B6"),
               var1,
               var2,
               true
            )
      ...
      protected X9ECParameters createParameters() {
         ...
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = TeleTrusTNamedCurves.configureBasepoint(
            var2, "048BD2AEB9CB7E57CB2C4B482FFC81B7AFB9DE27E1E3BD23C23A4453BD9ACE3262547EF835C3DAC4FD97F8461A14611DC9C27745132DED8E545C1D54C72F046997"
         );
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), (byte[])var1);
      }
   };
   static X9ECParametersHolder brainpoolP256t1 = new X9ECParametersHolder() {
      ...
      protected ECCurve createCurve() {
         ...
         return TeleTrusTNamedCurves.configureCurve(
            new ECCurve.Fp(
               TeleTrusTNamedCurves.fromHex("A9FB57DBA1EEA9BC3E660A909D838D726E3BF623D52620282013481D1F6E5377"),
               TeleTrusTNamedCurves.fromHex("A9FB57DBA1EEA9BC3E660A909D838D726E3BF623D52620282013481D1F6E5374"),
               TeleTrusTNamedCurves.fromHex("662C61C430D84EA4FE66A7733D0B76B7BF93EBC4AF2F49256AE58101FEE92B04"),
               var1,
               var2,
               true
            )
      ...
      protected X9ECParameters createParameters() {
         ...
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = TeleTrusTNamedCurves.configureBasepoint(
            var2, "04A3E8EB3CC1CFE7B7732213B23A656149AFA142C47AAFBC2B79A191562E1305F42D996C823439C56D7F7B22E14644417E69BCB6DE39D027001DABE8F35B25C9BE"
         );
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), (byte[])var1);
      }
   };
   static X9ECParametersHolder brainpoolP320r1 = new X9ECParametersHolder() {
      ...
      protected ECCurve createCurve() {
         ...
         return TeleTrusTNamedCurves.configureCurve(
            new ECCurve.Fp(
               TeleTrusTNamedCurves.fromHex("D35E472036BC4FB7E13C785ED201E065F98FCFA6F6F40DEF4F92B9EC7893EC28FCD412B1F1B32E27"),
               TeleTrusTNamedCurves.fromHex("3EE30B568FBAB0F883CCEBD46D3F3BB8A2A73513F5EB79DA66190EB085FFA9F492F375A97D860EB4"),
               TeleTrusTNamedCurves.fromHex("520883949DFDBC42D3AD198640688A6FE13F41349554B49ACC31DCCD884539816F5EB4AC8FB1F1A6"),
               var1,
               var2,
               true
            )
   ...
   static X9ECParametersHolder brainpoolP320t1 = new X9ECParametersHolder() {
      ...
      protected ECCurve createCurve() {
         ...
         return TeleTrusTNamedCurves.configureCurve(
            new ECCurve.Fp(
               TeleTrusTNamedCurves.fromHex("D35E472036BC4FB7E13C785ED201E065F98FCFA6F6F40DEF4F92B9EC7893EC28FCD412B1F1B32E27"),
               TeleTrusTNamedCurves.fromHex("D35E472036BC4FB7E13C785ED201E065F98FCFA6F6F40DEF4F92B9EC7893EC28FCD412B1F1B32E24"),
               TeleTrusTNamedCurves.fromHex("A7F561E038EB1ED560B3D147DB782013064C19F27ED27C6780AAF77FB8A547CEB5B4FEF422340353"),
               var1,
               var2,
               true
            )
   ...
   static X9ECParametersHolder brainpoolP384r1 = new X9ECParametersHolder() {
      ...
      protected ECCurve createCurve() {
         ...
         return TeleTrusTNamedCurves.configureCurve(
            new ECCurve.Fp(
               TeleTrusTNamedCurves.fromHex("8CB91E82A3386D280F5D6F7E50E641DF152F7109ED5456B412B1DA197FB71123ACD3A729901D1A71874700133107EC53"),
               TeleTrusTNamedCurves.fromHex("7BC382C63D8C150C3C72080ACE05AFA0C2BEA28E4FB22787139165EFBA91F90F8AA5814A503AD4EB04A8C7DD22CE2826"),
               TeleTrusTNamedCurves.fromHex("04A8C7DD22CE28268B39B55416F0447C2FB77DE107DCD2A62E880EA53EEB62D57CB4390295DBC9943AB78696FA504C11"),
               var1,
               var2,
               true
            )
   ...
   static X9ECParametersHolder brainpoolP384t1 = new X9ECParametersHolder() {
      ...
      protected ECCurve createCurve() {
         ...
         return TeleTrusTNamedCurves.configureCurve(
            new ECCurve.Fp(
               TeleTrusTNamedCurves.fromHex("8CB91E82A3386D280F5D6F7E50E641DF152F7109ED5456B412B1DA197FB71123ACD3A729901D1A71874700133107EC53"),
               TeleTrusTNamedCurves.fromHex("8CB91E82A3386D280F5D6F7E50E641DF152F7109ED5456B412B1DA197FB71123ACD3A729901D1A71874700133107EC50"),
               TeleTrusTNamedCurves.fromHex("7F519EADA7BDA81BD826DBA647910F8C4B9346ED8CCDC64E4B1ABD11756DCE1D2074AA263B88805CED70355A33B471EE"),
               var1,
               var2,
               true
            )
   ...
   static X9ECParametersHolder brainpoolP512r1 = new X9ECParametersHolder() {
      @Override
      protected ECCurve createCurve() {
         BigInteger var1 = TeleTrusTNamedCurves.fromHex(
