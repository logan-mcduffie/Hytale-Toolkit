...
public class PrivateKeyPossessionStatement extends ASN1Object {
   ...
   public static PrivateKeyPossessionStatement getInstance(Object var0) {
      if (var0 instanceof PrivateKeyPossessionStatement) {
         return (PrivateKeyPossessionStatement)var0;
      } else {
         return var0 != null ? new PrivateKeyPossessionStatement(ASN1Sequence.getInstance(var0)) : null;
      }
   }

   private PrivateKeyPossessionStatement(ASN1Sequence var1) {
      if (var1.size() == 1) {
   ...
   public PrivateKeyPossessionStatement(IssuerAndSerialNumber var1) {
      this.signer = var1;
      this.cert = null;
   }

   public PrivateKeyPossessionStatement(Certificate var1) {
