...
public final class NoOpTransactionProfiler implements ITransactionProfiler {
   ...
   @Nullable
   @Override
   public ProfilingTraceData onTransactionFinish(
      @NotNull ITransaction transaction, @Nullable List<PerformanceCollectionData> performanceCollectionData, @NotNull SentryOptions options
   ) {
      return null;
   }
