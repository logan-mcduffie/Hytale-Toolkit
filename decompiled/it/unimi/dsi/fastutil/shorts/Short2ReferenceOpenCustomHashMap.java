         ...
         if (!(o instanceof Entry)) {
            ...
            if (e.getKey() != null && e.getKey() instanceof Short) {
               ...
               if (Short2ReferenceOpenCustomHashMap.this.strategy.equals(k, (short)0)) {
                  ...
                  int pos;
                  if ((
                        curr = key[pos = HashCommon.mix(Short2ReferenceOpenCustomHashMap.this.strategy.hashCode(k))
                           & Short2ReferenceOpenCustomHashMap.this.mask]
                     )
                     == 0) {
                     return false;
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Short2ReferenceOpenCustomHashMap<V>.MapSpliterator<ConsumerType, SplitType>> {
      ...
      public boolean tryAdvance(ConsumerType action) {
         if (this.mustReturnNull) {
            ...
            for (short[] key = Short2ReferenceOpenCustomHashMap.this.key; this.pos < this.max; this.pos++) {
               if (key[this.pos] != 0) {
                  this.c++;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ...
            : Math.min(
               (long)(Short2ReferenceOpenCustomHashMap.this.size - this.c),
