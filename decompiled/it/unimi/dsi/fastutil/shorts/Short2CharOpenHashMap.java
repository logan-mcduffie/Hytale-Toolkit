         ...
         if (!(o instanceof Entry)) {
            ...
            if (e.getKey() == null || !(e.getKey() instanceof Short)) {
               ...
               if (k == 0) {
                  ...
                  short curr;
                  int pos;
                  if ((curr = key[pos = HashCommon.mix((int)k) & Short2CharOpenHashMap.this.mask]) == 0) {
                     return false;
                  } else if (k == curr) {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               int p = HashCommon.mix((int)k) & Short2CharOpenHashMap.this.mask;
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Short2CharOpenHashMap.MapSpliterator<ConsumerType, SplitType>> {
      ...
      public boolean tryAdvance(ConsumerType action) {
         if (this.mustReturnNull) {
            ...
            for (short[] key = Short2CharOpenHashMap.this.key; this.pos < this.max; this.pos++) {
               if (key[this.pos] != 0) {
                  this.c++;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ...
            : Math.min(
               (long)(Short2CharOpenHashMap.this.size - this.c),
