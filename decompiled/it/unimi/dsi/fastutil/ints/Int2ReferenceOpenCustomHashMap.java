         ...
         if (!(o instanceof Entry)) {
            ...
            if (e.getKey() != null && e.getKey() instanceof Integer) {
               ...
               if (Int2ReferenceOpenCustomHashMap.this.strategy.equals(k, 0)) {
                  ...
                  int curr;
                  int pos;
                  if ((curr = key[pos = HashCommon.mix(Int2ReferenceOpenCustomHashMap.this.strategy.hashCode(k)) & Int2ReferenceOpenCustomHashMap.this.mask])
                     == 0) {
                     return false;
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Int2ReferenceOpenCustomHashMap<V>.MapSpliterator<ConsumerType, SplitType>> {
      ...
      public boolean tryAdvance(ConsumerType action) {
         if (this.mustReturnNull) {
            ...
            for (int[] key = Int2ReferenceOpenCustomHashMap.this.key; this.pos < this.max; this.pos++) {
               if (key[this.pos] != 0) {
                  this.c++;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ...
            : Math.min(
               (long)(Int2ReferenceOpenCustomHashMap.this.size - this.c),
