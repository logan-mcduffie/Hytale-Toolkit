...
public abstract class AbstractLong2CharSortedMap extends AbstractLong2CharMap implements Long2CharSortedMap {
   ...
   protected class KeySet extends AbstractLongSortedSet {
      ...
      public LongBidirectionalIterator iterator(long from) {
         return new AbstractLong2CharSortedMap.KeySetIterator(
            AbstractLong2CharSortedMap.this.long2CharEntrySet().iterator(new AbstractLong2CharMap.BasicEntry(from, '\u0000'))
         );
      }
