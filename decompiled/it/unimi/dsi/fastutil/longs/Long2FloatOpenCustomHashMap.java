            ...
            if (e.getKey() != null && e.getKey() instanceof Long) {
               if (e.getValue() != null && e.getValue() instanceof Float) {
                  ...
                  if (Long2FloatOpenCustomHashMap.this.strategy.equals(k, 0L)) {
                     ...
                     long curr;
                     int pos;
                     if ((curr = key[pos = HashCommon.mix(Long2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Long2FloatOpenCustomHashMap.this.mask])
                        == 0L) {
                        return false;
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Long2FloatOpenCustomHashMap.MapSpliterator<ConsumerType, SplitType>> {
      ...
      public boolean tryAdvance(ConsumerType action) {
         if (this.mustReturnNull) {
            ...
            for (long[] key = Long2FloatOpenCustomHashMap.this.key; this.pos < this.max; this.pos++) {
               if (key[this.pos] != 0L) {
                  this.c++;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ...
            : Math.min(
               (long)(Long2FloatOpenCustomHashMap.this.size - this.c),
