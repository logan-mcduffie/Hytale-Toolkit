         ...
         if (!(o instanceof Entry)) {
            ...
            if (e.getKey() == null || !(e.getKey() instanceof Long)) {
               ...
               if (Long2BooleanOpenCustomHashMap.this.strategy.equals(k, 0L)) {
                  return Long2BooleanOpenCustomHashMap.this.containsNullKey
                     && Long2BooleanOpenCustomHashMap.this.value[Long2BooleanOpenCustomHashMap.this.n] == v;
               } else {
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Long2BooleanOpenCustomHashMap.MapSpliterator<ConsumerType, SplitType>> {
      ...
      public boolean tryAdvance(ConsumerType action) {
         if (this.mustReturnNull) {
            ...
            for (long[] key = Long2BooleanOpenCustomHashMap.this.key; this.pos < this.max; this.pos++) {
               if (key[this.pos] != 0L) {
                  this.c++;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ...
            : Math.min(
               (long)(Long2BooleanOpenCustomHashMap.this.size - this.c),
