            ...
            if (e.getKey() != null && e.getKey() instanceof Character) {
               if (e.getValue() != null && e.getValue() instanceof Double) {
                  ...
                  if (Char2DoubleOpenCustomHashMap.this.strategy.equals(k, '\u0000')) {
                     ...
                     char curr;
                     int pos;
                     if ((curr = key[pos = HashCommon.mix(Char2DoubleOpenCustomHashMap.this.strategy.hashCode(k)) & Char2DoubleOpenCustomHashMap.this.mask])
                        == 0) {
                        return false;
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Char2DoubleOpenCustomHashMap.MapSpliterator<ConsumerType, SplitType>> {
      ...
      public boolean tryAdvance(ConsumerType action) {
         if (this.mustReturnNull) {
            ...
            for (char[] key = Char2DoubleOpenCustomHashMap.this.key; this.pos < this.max; this.pos++) {
               if (key[this.pos] != 0) {
                  this.c++;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ...
            : Math.min(
               (long)(Char2DoubleOpenCustomHashMap.this.size - this.c),
