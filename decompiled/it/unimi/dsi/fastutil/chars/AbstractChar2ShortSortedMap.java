...
public abstract class AbstractChar2ShortSortedMap extends AbstractChar2ShortMap implements Char2ShortSortedMap {
   ...
   protected class KeySet extends AbstractCharSortedSet {
      ...
      public CharBidirectionalIterator iterator(char from) {
         return new AbstractChar2ShortSortedMap.KeySetIterator(
            AbstractChar2ShortSortedMap.this.char2ShortEntrySet().iterator(new AbstractChar2ShortMap.BasicEntry(from, (short)0))
         );
      }
