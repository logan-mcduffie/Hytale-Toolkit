         ...
         if (!(o instanceof Entry)) {
            ...
            if (e.getKey() == null || !(e.getKey() instanceof Character)) {
               ...
               if (Char2BooleanOpenCustomHashMap.this.strategy.equals(k, '\u0000')) {
                  return Char2BooleanOpenCustomHashMap.this.containsNullKey
                     && Char2BooleanOpenCustomHashMap.this.value[Char2BooleanOpenCustomHashMap.this.n] == v;
               } else {
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Char2BooleanOpenCustomHashMap.MapSpliterator<ConsumerType, SplitType>> {
      ...
      public boolean tryAdvance(ConsumerType action) {
         if (this.mustReturnNull) {
            ...
            for (char[] key = Char2BooleanOpenCustomHashMap.this.key; this.pos < this.max; this.pos++) {
               if (key[this.pos] != 0) {
                  this.c++;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ...
            : Math.min(
               (long)(Char2BooleanOpenCustomHashMap.this.size - this.c),
