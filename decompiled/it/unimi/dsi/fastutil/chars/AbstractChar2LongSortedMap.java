...
public abstract class AbstractChar2LongSortedMap extends AbstractChar2LongMap implements Char2LongSortedMap {
   ...
   protected class KeySet extends AbstractCharSortedSet {
      ...
      public CharBidirectionalIterator iterator(char from) {
         return new AbstractChar2LongSortedMap.KeySetIterator(
            AbstractChar2LongSortedMap.this.char2LongEntrySet().iterator(new AbstractChar2LongMap.BasicEntry(from, 0L))
         );
      }
