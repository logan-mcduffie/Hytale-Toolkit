         ...
         if (!(o instanceof Entry)) {
            ...
            if (e.getValue() != null && e.getValue() instanceof Character) {
               ...
               if (Object2CharOpenCustomHashMap.this.strategy.equals(k, null)) {
                  ...
                  K curr;
                  int pos;
                  if ((curr = key[pos = HashCommon.mix(Object2CharOpenCustomHashMap.this.strategy.hashCode(k)) & Object2CharOpenCustomHashMap.this.mask])
                     == null) {
                     return false;
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Object2CharOpenCustomHashMap<K>.MapSpliterator<ConsumerType, SplitType>> {
      ...
      public boolean tryAdvance(ConsumerType action) {
         if (this.mustReturnNull) {
            ...
            for (K[] key = Object2CharOpenCustomHashMap.this.key; this.pos < this.max; this.pos++) {
               if (key[this.pos] != null) {
                  this.c++;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ...
            : Math.min(
               (long)(Object2CharOpenCustomHashMap.this.size - this.c),
