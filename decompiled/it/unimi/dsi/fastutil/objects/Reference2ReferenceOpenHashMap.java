   ...
   private final class MapEntrySet extends AbstractObjectSet<Reference2ReferenceMap.Entry<K, V>> implements Reference2ReferenceMap.FastEntrySet<K, V> {
      ...
      public boolean contains(Object o) {
         if (!(o instanceof Entry)) {
            ...
            V v = (V)e.getValue();
            if (k == null) {
               return Reference2ReferenceOpenHashMap.this.containsNullKey
                  && Reference2ReferenceOpenHashMap.this.value[Reference2ReferenceOpenHashMap.this.n] == v;
            } else {
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Reference2ReferenceOpenHashMap<K, V>.MapSpliterator<ConsumerType, SplitType>> {
      ...
      public boolean tryAdvance(ConsumerType action) {
         if (this.mustReturnNull) {
            ...
            for (K[] key = Reference2ReferenceOpenHashMap.this.key; this.pos < this.max; this.pos++) {
               if (key[this.pos] != null) {
                  this.c++;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ...
            : Math.min(
               (long)(Reference2ReferenceOpenHashMap.this.size - this.c),
