               ...
               if ((curr = key[pos = HashCommon.mix(Reference2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2ObjectOpenCustomHashMap.this.mask])
                  ...
                  while ((curr = key[pos = pos + 1 & Reference2ObjectOpenCustomHashMap.this.mask]) != null) {
                     if (Reference2ObjectOpenCustomHashMap.this.strategy.equals(curr, k)
                        && Objects.equals(Reference2ObjectOpenCustomHashMap.this.value[pos], v)) {
                        Reference2ObjectOpenCustomHashMap.this.removeEntry(pos);
                        return true;
                     }
                  }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Reference2ObjectOpenCustomHashMap<K, V>.MapSpliterator<ConsumerType, SplitType>> {
      ...
      public boolean tryAdvance(ConsumerType action) {
         if (this.mustReturnNull) {
            ...
            for (K[] key = Reference2ObjectOpenCustomHashMap.this.key; this.pos < this.max; this.pos++) {
               if (key[this.pos] != null) {
                  this.c++;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ...
            : Math.min(
               (long)(Reference2ObjectOpenCustomHashMap.this.size - this.c),
