         ...
         if (!(o instanceof Entry)) {
            ...
            if (e.getValue() != null && e.getValue() instanceof Float) {
               ...
               if (Reference2FloatOpenCustomHashMap.this.strategy.equals(k, null)) {
                  ...
                  int pos;
                  if ((
                        curr = key[pos = HashCommon.mix(Reference2FloatOpenCustomHashMap.this.strategy.hashCode(k))
                           & Reference2FloatOpenCustomHashMap.this.mask]
                     )
                     == null) {
                     return false;
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Reference2FloatOpenCustomHashMap<K>.MapSpliterator<ConsumerType, SplitType>> {
      ...
      public boolean tryAdvance(ConsumerType action) {
         if (this.mustReturnNull) {
            ...
            for (K[] key = Reference2FloatOpenCustomHashMap.this.key; this.pos < this.max; this.pos++) {
               if (key[this.pos] != null) {
                  this.c++;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ...
            : Math.min(
               (long)(Reference2FloatOpenCustomHashMap.this.size - this.c),
