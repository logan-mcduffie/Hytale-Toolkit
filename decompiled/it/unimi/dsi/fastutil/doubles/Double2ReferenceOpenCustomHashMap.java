            ...
            if (e.getKey() != null && e.getKey() instanceof Double) {
               ...
               if (Double2ReferenceOpenCustomHashMap.this.strategy.equals(k, 0.0)) {
                  ...
                  if (Double.doubleToLongBits(
                        curr = key[pos = HashCommon.mix(Double2ReferenceOpenCustomHashMap.this.strategy.hashCode(k))
                           & Double2ReferenceOpenCustomHashMap.this.mask]
                     )
                     == 0L) {
                     return false;
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Double2ReferenceOpenCustomHashMap<V>.MapSpliterator<ConsumerType, SplitType>> {
      ...
      public boolean tryAdvance(ConsumerType action) {
         if (this.mustReturnNull) {
            ...
            for (double[] key = Double2ReferenceOpenCustomHashMap.this.key; this.pos < this.max; this.pos++) {
               if (Double.doubleToLongBits(key[this.pos]) != 0L) {
                  this.c++;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ...
            : Math.min(
               (long)(Double2ReferenceOpenCustomHashMap.this.size - this.c),
