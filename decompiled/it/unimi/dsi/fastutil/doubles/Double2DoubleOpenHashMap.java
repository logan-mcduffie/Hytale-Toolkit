            ...
            if (e.getKey() != null && e.getKey() instanceof Double) {
               if (e.getValue() != null && e.getValue() instanceof Double) {
                  ...
                  if (Double.doubleToLongBits(k) == 0L) {
                     ...
                     double curr;
                     int pos;
                     if (Double.doubleToLongBits(curr = key[pos = (int)HashCommon.mix(Double.doubleToRawLongBits(k)) & Double2DoubleOpenHashMap.this.mask])
                        == 0L) {
                        return false;
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Double2DoubleOpenHashMap.MapSpliterator<ConsumerType, SplitType>> {
      ...
      public boolean tryAdvance(ConsumerType action) {
         if (this.mustReturnNull) {
            ...
            for (double[] key = Double2DoubleOpenHashMap.this.key; this.pos < this.max; this.pos++) {
               if (Double.doubleToLongBits(key[this.pos]) != 0L) {
                  this.c++;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ...
            : Math.min(
               (long)(Double2DoubleOpenHashMap.this.size - this.c),
