            ...
            if (e.getKey() != null && e.getKey() instanceof Double) {
               if (e.getValue() != null && e.getValue() instanceof Boolean) {
                  ...
                  if (Double2BooleanOpenCustomHashMap.this.strategy.equals(k, 0.0)) {
                     ...
                     int pos;
                     if (Double.doubleToLongBits(
                           curr = key[pos = HashCommon.mix(Double2BooleanOpenCustomHashMap.this.strategy.hashCode(k))
                              & Double2BooleanOpenCustomHashMap.this.mask]
                        )
                        == 0L) {
                        return false;
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Double2BooleanOpenCustomHashMap.MapSpliterator<ConsumerType, SplitType>> {
      ...
      public boolean tryAdvance(ConsumerType action) {
         if (this.mustReturnNull) {
            ...
            for (double[] key = Double2BooleanOpenCustomHashMap.this.key; this.pos < this.max; this.pos++) {
               if (Double.doubleToLongBits(key[this.pos]) != 0L) {
                  this.c++;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ...
            : Math.min(
               (long)(Double2BooleanOpenCustomHashMap.this.size - this.c),
