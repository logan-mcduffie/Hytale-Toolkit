         ...
         if (!(o instanceof Entry)) {
            ...
            if (e.getKey() == null || !(e.getKey() instanceof Byte)) {
               ...
               if (k == 0) {
                  ...
                  byte curr;
                  int pos;
                  if ((curr = key[pos = HashCommon.mix((int)k) & Byte2LongOpenHashMap.this.mask]) == 0) {
                     return false;
                  } else if (k == curr) {
      ...
      public int nextEntry() {
         if (!this.hasNext()) {
            ...
            if (this.mustReturnNullKey) {
               ...
               int p = HashCommon.mix((int)k) & Byte2LongOpenHashMap.this.mask;
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Byte2LongOpenHashMap.MapSpliterator<ConsumerType, SplitType>> {
      ...
      public boolean tryAdvance(ConsumerType action) {
         if (this.mustReturnNull) {
            ...
            for (byte[] key = Byte2LongOpenHashMap.this.key; this.pos < this.max; this.pos++) {
               if (key[this.pos] != 0) {
                  this.c++;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ...
            : Math.min(
               (long)(Byte2LongOpenHashMap.this.size - this.c),
