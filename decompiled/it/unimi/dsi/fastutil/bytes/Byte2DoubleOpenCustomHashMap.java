            ...
            if (e.getKey() != null && e.getKey() instanceof Byte) {
               if (e.getValue() != null && e.getValue() instanceof Double) {
                  ...
                  if (Byte2DoubleOpenCustomHashMap.this.strategy.equals(k, (byte)0)) {
                     ...
                     byte curr;
                     int pos;
                     if ((curr = key[pos = HashCommon.mix(Byte2DoubleOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2DoubleOpenCustomHashMap.this.mask])
                        == 0) {
                        return false;
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Byte2DoubleOpenCustomHashMap.MapSpliterator<ConsumerType, SplitType>> {
      ...
      public boolean tryAdvance(ConsumerType action) {
         if (this.mustReturnNull) {
            ...
            for (byte[] key = Byte2DoubleOpenCustomHashMap.this.key; this.pos < this.max; this.pos++) {
               if (key[this.pos] != 0) {
                  this.c++;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ...
            : Math.min(
               (long)(Byte2DoubleOpenCustomHashMap.this.size - this.c),
