...
public abstract class AbstractFloat2IntSortedMap extends AbstractFloat2IntMap implements Float2IntSortedMap {
   ...
   protected class KeySet extends AbstractFloatSortedSet {
      ...
      public FloatBidirectionalIterator iterator(float from) {
         return new AbstractFloat2IntSortedMap.KeySetIterator(
            AbstractFloat2IntSortedMap.this.float2IntEntrySet().iterator(new AbstractFloat2IntMap.BasicEntry(from, 0))
         );
      }
