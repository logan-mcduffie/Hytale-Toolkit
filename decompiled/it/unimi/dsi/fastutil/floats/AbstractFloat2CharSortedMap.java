...
public abstract class AbstractFloat2CharSortedMap extends AbstractFloat2CharMap implements Float2CharSortedMap {
   ...
   protected class KeySet extends AbstractFloatSortedSet {
      ...
      public FloatBidirectionalIterator iterator(float from) {
         return new AbstractFloat2CharSortedMap.KeySetIterator(
            AbstractFloat2CharSortedMap.this.float2CharEntrySet().iterator(new AbstractFloat2CharMap.BasicEntry(from, '\u0000'))
         );
      }
