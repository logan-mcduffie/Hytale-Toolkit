...
public abstract class AbstractFloat2BooleanSortedMap extends AbstractFloat2BooleanMap implements Float2BooleanSortedMap {
   ...
   protected class KeySet extends AbstractFloatSortedSet {
      ...
      public FloatBidirectionalIterator iterator(float from) {
         return new AbstractFloat2BooleanSortedMap.KeySetIterator(
            AbstractFloat2BooleanSortedMap.this.float2BooleanEntrySet().iterator(new AbstractFloat2BooleanMap.BasicEntry(from, false))
         );
      }
