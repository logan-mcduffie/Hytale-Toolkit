   ...
   private class SetSpliterator implements FloatSpliterator {
      ...
      public boolean tryAdvance(FloatConsumer action) {
         if (this.mustReturnNull) {
            ...
            for (float[][] key = FloatOpenHashBigSet.this.key; this.pos < this.max; this.pos++) {
      ...
      public FloatOpenHashBigSet.SetSpliterator trySplit() {
         if (this.pos >= this.max - 1L) {
            ...
            if (retLen <= 1L) {
               ...
               FloatOpenHashBigSet.SetSpliterator split = FloatOpenHashBigSet.this.new SetSpliterator(retPos, myNewPos, this.mustReturnNull, true);
               this.pos = myNewPos;
               this.mustReturnNull = false;
               this.hasSplit = true;
               return split;
