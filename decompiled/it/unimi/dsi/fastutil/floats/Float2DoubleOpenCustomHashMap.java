         ...
         if (!(o instanceof Entry)) {
            ...
            if (e.getKey() != null && e.getKey() instanceof Float) {
               if (e.getValue() != null && e.getValue() instanceof Double) {
                  ...
                  if (Float2DoubleOpenCustomHashMap.this.strategy.equals(k, 0.0F)) {
                     if (Float2DoubleOpenCustomHashMap.this.containsNullKey
                        && Double.doubleToLongBits(Float2DoubleOpenCustomHashMap.this.value[Float2DoubleOpenCustomHashMap.this.n])
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Float2DoubleOpenCustomHashMap.MapSpliterator<ConsumerType, SplitType>> {
      ...
      public boolean tryAdvance(ConsumerType action) {
         if (this.mustReturnNull) {
            ...
            for (float[] key = Float2DoubleOpenCustomHashMap.this.key; this.pos < this.max; this.pos++) {
               if (Float.floatToIntBits(key[this.pos]) != 0) {
                  this.c++;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ...
            : Math.min(
               (long)(Float2DoubleOpenCustomHashMap.this.size - this.c),
