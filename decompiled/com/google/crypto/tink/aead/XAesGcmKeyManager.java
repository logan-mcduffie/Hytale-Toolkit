...
public final class XAesGcmKeyManager {
   ...
   private static final PrimitiveConstructor<XAesGcmKey, Aead> X_AES_GCM_PRIMITVE_CONSTRUCTOR = PrimitiveConstructor.create(
      XAesGcm::create, XAesGcmKey.class, Aead.class
   );
