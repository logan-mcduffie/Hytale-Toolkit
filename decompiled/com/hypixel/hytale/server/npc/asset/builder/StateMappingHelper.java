...
public class StateMappingHelper {
   ...
   public void optimise() {
      ...
      if (this.mainStateMap.isEmpty()) {
         ...
         ObjectIterator<Int2ObjectMap.Entry<StateMappingHelper.IStateMap>> iterator = Int2ObjectMaps.fastIterator(this.subStateMap);

         while (iterator.hasNext()) {
            Int2ObjectMap.Entry<StateMappingHelper.IStateMap> next = iterator.next();
